...
- (id)init
{
	...
	[OFMultiplayerService internalCreateMoveQueueWithOutgoingSize:256 withIncomingSize:256];
        ...
        for (NSNumber*index in mAnomalyProcessor.unprocessed) {
            ...
            switch(anomaly.action) {
                ...
                case Anomaly::ACTION_FINISH_GAME:
                    ...
                    for(int i=0; i<[anomaly.finishStates count]; ++i) {
...
namespace {
    ...
    void fillGameSlot(OFMultiplayerGame*slot, wn_stream_t*io) {
        ...
        if([[slot.previousValues objectForKey:@"gameId"] longLongValue] != slot.gameId) {
