...
// Auxiliary class for InterfaceBuilder creation of grey buttons without borders
@interface OFGreyButton : OFDefaultButton
@end
...
// Auxiliary class for InterfaceBuilder creation od button grey shadowed buttons
@interface OFShadowedGreyButton : OFDefaultButton
@end

// Auxiliary class for InterfaceBuilder creation od button gren shadowed buttons
@interface OFShadowedGreenButton : OFDefaultButton
@end