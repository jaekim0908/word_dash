...
- (void)_combineSectionsAndSortStickyFirst:(OFPaginatedSeries *)page nextCall:(OFDelegateChained *)next
{
...
+ (OFRequestHandle*)downloadAnnouncements
{
	...
	OFDelegate successFirst([OFAnnouncementService sharedInstance], @selector(_combineSectionsAndSortStickyFirst:nextCall:), chainedSuccess);	
