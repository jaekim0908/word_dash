...
-(BOOL) addToMyScene:(CCLayer *) myScene
{
    ...
    [myScene addChild:batchNode];

    self.pauseButton = [CCSprite spriteWithSpriteFrameName:@"pause_btn.png"];
    self.pauseButton.position = ccp(438, 292);
    [batchNode addChild:self.pauseButton];
    ...
    [batchNode addChild:self.wavesAndBeach z:100];
    ...
    [batchNode addChild:self.rematchButton z:100];
    ...
    [batchNode addChild:self.mainMenuButton z:100];
    ...
    [batchNode addChild:self.resumeButton z:100];
    ...
    [batchNode addChild:self.howToPlayButton z:100];

    [myScene addChild:self.pauseBackground z:100];
