...
- (void)populateResourceMap:(OFResourceControllerMap*)resourceMap
{
	...
	resourceMap->addResource([OFDeviceContact class], @"Contact");
}
...
- (void)inviteSuccess
{
	...
	if([inviteDelegate respondsToSelector:@selector(userSentInvites:)])
	{
		[inviteDelegate userSentInvites:selectedUsers];
	}
#endif
}
